...
class Problem:
    ...
    density: float  # noqa
    x_symmetry: bool  # noqa
    y_symmetry: bool  # noqa
...
def mbb_beam(
    ...
    return Problem(normals, forces, density, x_symmetry, y_symmetry)
...
def l_shape(
    ...
    return Problem(normals, forces, density, x_symmetry, y_symmetry, mask, tounn_mask)
